...
const Speedometer = ({
  ...
  allowedDecimals = 0,
  labels = [
    { name: "Very low", labelColor: "#ff2900", activeBarColor: "#00ff6b" },
    { name: "Low", labelColor: "#ff5400", activeBarColor: "#14eb6e" },
    {
      name: "Moderately low",
      labelColor: "#f4ab44",
    ...
    { name: "High", labelColor: "#14eb6e", activeBarColor: "#ff5400" },
    { name: "Very high", labelColor: "#00ff6b", activeBarColor: "#ff2900" },
  ],
